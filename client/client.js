...
var gameObjects = {
    ...
    menuContainer: null, //The ui container for menu elements
    mainMenu: true, //Whether the main menu is open
    menuClosed: false, //Whether the main menu has just closed
    config: null //The server config properties
};
 ...
 * @type {cl.Client}
 */
var client = new cl.Client(router, repository, gameObjects);
